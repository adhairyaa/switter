...
function Navbar() {
  ...
  return (
      ...
      <div className={styles.navbar}>
        ...
        <Link to="/feed"><div className={styles.navbar_items}>Explore</div></Link>
        <Link to="/feed"><div className={styles.navbar_items}>Notifications</div></Link>
        <Link to={`/profile/${loginedUser.username}`}> <div className={styles.navbar_items}>Profile</div></Link>
        </div>
